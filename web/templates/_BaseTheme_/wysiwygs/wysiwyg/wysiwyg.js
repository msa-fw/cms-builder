                    ...
                    '<thead>' +
                        '<tr>' +
                            '<th class="buttons-add" contenteditable="false">' +
                                '<span class="button-remove table-button" onclick="wysiwyg.commands.removeTableColumn(this)" contenteditable="false">-</span>' +
                                '<span class="button-add table-button" onclick="wysiwyg.commands.addTableColumn(this)" contenteditable="false">+</span>' +
                            '</th>' +
                            '<th>A</th>' +
                        '</tr>' +
                    '</thead>' +
                    '<tbody>' +
                        '<tr>' +
                            '<td class="buttons-add" contenteditable="false">' +
                                '<span class="button-remove table-button" onclick="wysiwyg.commands.removeTableRow(this)" contenteditable="false">-</span>' +
                                '<span class="button-add table-button" onclick="wysiwyg.commands.addTableRow(this)" contenteditable="false">+</span>' +
                            '</td>' +
                            '<td>' + content.text + '</td>' +
                        '</tr>' +
                    '</tbody>' +
